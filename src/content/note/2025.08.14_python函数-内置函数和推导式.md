...
20. **`eval(expression, globals=None, locals=None)`**
    ...
    `expression`
     ...
     中的表达式，并返回结果。
21. **`exec(object, globals=None, locals=None)`**
...
41. **`map(function, iterable, ...)`**
    ...
    `iterable`
     ...
     中的每个元素，并返回结果的迭代器。
42. **`max(iterable, *args, key=None, default=None)`**
...
43. **`memoryview(object)`**
    ...
    ：返回对象的内存视图。
44. **`min(iterable, *args, key=None, default=None)`**
